...
<head>
  ...
  <title>Sales dan Produksi Bulanan per Motif</title>
  ...
  <script src="../assets/js/WMSApi-20210818.js"></script>
  ...
  <script>
    ...
    function doOnLoad() {
      rootLayout = new dhtmlXLayoutObject({
        ...
        pattern: '2E',
        cells: [
          {id: CELL_REQUEST_FILTER, header: true, text: 'Laporan Sales dan Produksi Bulanan per Motif', height: 90},
    ...
    function setupRequestFilters(cell) {
      ...
      const filterFormConfig = [
        ...
        {type: 'newcolumn'},
        {
          ...
          offsetLeft: 20,
          inputWidth: 150,
          options: [{text: "Motif", value: "M"}, {text: "Motif dan Quality", value: "Q"}]
        },
        {type: 'newcolumn'},
        {
          type: 'combo',
    ...
    function fetchAvailableRequests(subplant, tiperpt, tahunrpt, gruprpt) {
      ...
      return WMSApi.location.getSalesDanProduksiBulanan(subplant, tiperpt, tahunrpt, gruprpt)
    ...
    function setupRequestGrid(cell) {
      ...
      toolbar.attachEvent('onClick', itemId => {
        const title = `Laporan Sales dan Produksi Bulanan per Motif Plant <?= PlantIdHelper::getCurrentPlant() ?>`;
        const exportTitle = `${title}`;
        if(itemId === 'clear_filters') {
          gridUtils.clearAllGridFilters(requestGrid);
        } else if(itemId === 'print') {
          const pdfColWidths = '45,55,200,150,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90';
          cell.progressOn();
      ...
      requestGrid.setHeader('NO.,SUBP.,MOTIF NAME,TIPE,UKURAN,JANUARI,'+COLSPAN+'FEBRUARI,'+COLSPAN+'MARET,'+COLSPAN+'APRIL,'+COLSPAN+'MEI,'+COLSPAN+'JUNI,'+COLSPAN+'JULI,'+COLSPAN+'AGUSTUS,'+COLSPAN+'SEPTEMBER,'+COLSPAN+'OKTOBER,'+COLSPAN+'NOVEMBER,'+COLSPAN+'DESEMBER,'+COLSPAN+'PRODUKSI,'+COLSPAN+'SALES,'+COLSPAN+'CURRENT<br>QTY,REPEAT<br>PROD.',null,
      ...
      requestGrid.setColumnIds('no,subplant,motif_nama,group_nama,ukuran,janprod,jansale,febprod,febsale,marprod,marsale,aprprod,aprsale,meiprod,meisale,junprod,junsale,julprod,julsale,aguprod,agusale,sepprod,sepsale,oktprod,oktsale,novprod,novsale,desprod,dessale,totprod,senprod,totsale,sensale,stok,repeatprod');
      ...
      requestGrid.setInitWidths('45,55,200,150,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90');
      requestGrid.setColAlign('right,left,left,left,center,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right');
      ...
      requestGrid.attachHeader([
        '&nbsp;', FILTERS.SELECT, FILTERS.TEXT, FILTERS.SELECT, FILTERS.SELECT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT
      ]);
    ...
    function setupRequest2Grid(cell) {
      ...
      toolbar.attachEvent('onClick', itemId => {
        ...
        if(itemId === 'clear_filters') {
          ...
          const pdfColWidths = '45,55,200,150,100,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90';
          cell.progressOn();
          gridUtils.generateFilteredPdf(requestGrid, exportTitle, USERID, pdfColWidths)
            .getBlob(blob => {
              cell.progressOff();
      ...
      const FILTERS = gridUtils.headerFilters;
      const requestGrid = cell.attachGrid();
      requestGrid.setHeader('NO.,SUBP.,MOTIF NAME,TIPE,UKURAN,QUALITY,JANUARI,'+COLSPAN+'FEBRUARI,'+COLSPAN+'MARET,'+COLSPAN+'APRIL,'+COLSPAN+'MEI,'+COLSPAN+'JUNI,'+COLSPAN+'JULI,'+COLSPAN+'AGUSTUS,'+COLSPAN+'SEPTEMBER,'+COLSPAN+'OKTOBER,'+COLSPAN+'NOVEMBER,'+COLSPAN+'DESEMBER,'+COLSPAN+'PRODUKSI,'+COLSPAN+'SALES,'+COLSPAN+'CURRENT<br>QTY,REPEAT<br>PROD.',null,
        ['','','','','','',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'',TEXT_CENTER,'','','']
      );
      requestGrid.attachHeader([ROWSPAN,ROWSPAN,ROWSPAN,ROWSPAN,ROWSPAN,ROWSPAN,'PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','PROD.','SALES','TOTAL','PERSEN (%)','TOTAL','PERSEN (%)',ROWSPAN,ROWSPAN
      ]);
      requestGrid.setColumnIds('no,subplant,motif_nama,group_nama,ukuran,quality,janprod,jansale,febprod,febsale,marprod,marsale,aprprod,aprsale,meiprod,meisale,junprod,junsale,julprod,julsale,aguprod,agusale,sepprod,sepsale,oktprod,oktsale,novprod,novsale,desprod,dessale,totprod,senprod,totsale,sensale,stok,repeatprod');
      requestGrid.setColTypes('cntr,rotxt,rotxt,rotxt,rotxt,rotxt,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron,ron');
      requestGrid.setInitWidths('45,55,200,150,90,100,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90,90');
      requestGrid.setColAlign('right,left,left,left,center,left,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right,right');
      requestGrid.setColSorting('na,str,str,str,str,str,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int,int');
      requestGrid.attachHeader([
        '&nbsp;', FILTERS.SELECT, FILTERS.TEXT, FILTERS.SELECT, FILTERS.SELECT, FILTERS.SELECT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT
      ]);
      requestGrid.attachFooter(['Grand Total', '#cspan', '#cspan', '#cspan', '#cspan', '#cspan', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total', '#stat_total',''],
          [TEXT_RIGHT_ALIGN + TEXT_BOLD, '', '', '', '', '', TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, TEXT_RIGHT_ALIGN + TEXT_BOLD, '']);
      requestGrid.setColumnColor('#FFF,#FFF,#FFF,#FFF,#FFF,#FFF,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#F7F7F7,#FFF,#FFF,#F7F7F7,#F7F7F7,#FFF,#FFF');
      requestGrid.setNumberFormat("0,000", requestGrid.getColIndexById('janprod'), ",", ".");
      requestGrid.setNumberFormat("0,000", requestGrid.getColIndexById('febprod'), ",", ".");
      requestGrid.setNumberFormat("0,000", requestGrid.getColIndexById('marprod'), ",", ".");
      requestGrid.setNumberFormat("0,000", requestGrid.getColIndexById('aprprod'), ",", ".");
