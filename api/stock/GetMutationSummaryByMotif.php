...
SELECT 
    ...
    COALESCE(a.quality, b.quality) quality,
...
FROM (
    SELECT t1.subplant, t1.quality, t1.motif_dimension, t1.motif_id, t1.motif_name,
    ...
    WHERE t1.mutation_date >= $1
      AND t1.mutation_date <= $2
      AND $subplantFilter
      AND $motifFilter
    GROUP BY t1.subplant, t1.quality, t1.motif_dimension, t1.motif_id, t1.motif_name
) a
FULL JOIN
(SELECT subplant, quality, motif_id, motif_name, motif_dimension,
  ...
  WHERE t2.mutation_date < $1
    AND $subplantFilter
    AND $motifFilter
  GROUP BY subplant, quality, motif_dimension, motif_id, motif_name
...
ORDER BY subplant, motif_dimension, quality, motif_name";
