...
$requests = HttpUtils::getRequestValues(array('id', 'is_approved', 'reason'));
$requestErrors = array();
...
$isApproved = RequestParamProcessor::getBoolean($requests['is_approved']);
$reason = null;
if (!$isApproved) {
...
try {
    ...
    $query = 'SELECT approve_downgrade($1, $2, $3, $4)';
    $params = array($downgradeId, $isApproved, $userid, $reason);
