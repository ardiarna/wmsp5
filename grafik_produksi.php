...
<body>
  ...
  <script type="text/javascript">
    ...
    function loadChart() {
      $.ajax({
        url: FRM+ "?mode=produksi&jns="+vJns+"&tpe="+vTpe+"&tgl="+vTgl+"&tglb="+vTglb+"&thn="+vThn+"&sub="+vSub+"&line="+vLine, 
        success: function(result){
          var o = JSON.parse(result);
          tampilChart('kontener1', 'column', 'Hasil Produksi', {type: 'category',categories:o.kategori}, true, o.data_a);
          ...
          if(vJns == 'P') {
            for(a of o.kategori){
              ...
              if (hari == 0) {
                tabelnya += '<th style="background-color:red;">'+a+'</th>';
              } else {
                tabelnya += '<th>'+a+'</th>';  
              }
