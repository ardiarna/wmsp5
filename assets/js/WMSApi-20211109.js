...
function getBlockQuantityRequests(subplant, fromDate, toDate, status) {
  ...
  const location = {
    ...
    createBlockQuantityRequests, updateBlockQuantityRequests, cancelBlockQuantityRequests, completeBlockQuantityRequests, getSalesDanProduksiBulanan, getSalesDanProduksiBulananTipe
  };
  const stock = {
    getPalletInfo,
