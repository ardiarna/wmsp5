(function (global, factory) {
  ...
  function openAggregateMutationDetailsWindow(windows, mutationType, subplants, dateFrom, dateTo, motifIds, colName) {
    ...
    if (mutationType === COLUMN_MAP.initial_quantity) {
      ...
      grid.setHeader(
        'SUBP.,KD. MOTIF,QLTY.,DIM.,MOTIF,TIPE PRODUKSI,LOKASI,TGL.,MUT.,NO. PALET,TTL. PLT.,NO. BA MUAT,NO. SJ.,TOKO TUJUAN,ALAMAT SJ.,QTY.',
        null,
        ['', '', '', '', '', '', '', '', '', '', '', '', '', '', '', STYLES.TEXT_RIGHT_ALIGN]
      );
      grid.setColTypes('ro,ro,ro,ro,ro,ro,ro,ro_date,ro,ron,ro,ro,ro,ro,ro,ron');
      grid.setColumnIds('subplant,motif_id,quality,motif_dimension,motif_name,tipe_produksi,lokasi,mutation_date,mutation_type,pallet_no,pallet_count,mutation_id,ref_txn_id,toko,alamat,quantity');
      grid.setInitWidths('60,0,60,60,*,120,180,120,40,130,80,120,120,180,210,80');
      grid.setColumnMinWidth('60,0,60,60,180,120,180,120,40,130,80,120,120,180,210,80');
      grid.attachHeader([FILTERS.SELECT, '&nbsp;', FILTERS.SELECT, FILTERS.SELECT, FILTERS.TEXT, FILTERS.SELECT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.NUMERIC, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.NUMERIC]);
      grid.setColAlign('left,left,left,left,left,left,left,left,left,left,right,left,left,left,left,right');
      grid.setColSorting('str,str,str,str,str,str,str,str,str,str,int,str,str,str,str,int');
      grid.attachFooter(['&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', 'Total', gridUtils.spans.COLUMN, '&nbsp;', gridUtils.reducers.STATISTICS_TOTAL, '&nbsp;', '&nbsp;', '&nbsp;', '&nbsp;', gridUtils.reducers.STATISTICS_TOTAL],
        ['', '', '', '', '', '', '', STYLES.TEXT_BOLD + STYLES.TEXT_CENTER_ALIGN, '', '', STYLES.TEXT_BOLD + STYLES.TEXT_RIGHT_ALIGN, '', '', '', '', STYLES.TEXT_BOLD + STYLES.TEXT_RIGHT_ALIGN]);
    } else {
      grid.setHeader(
          ...
          reducer = (map, current) => {
            ...
            if (map.has(id)) {
              ...
              map.set(id, {
                ...
                tipe_produksi: current.tipe_produksi,
                subplant: current.subplant,
                motif_id: current.motif_id,
                motif_dimension: current.motif_dimension,
                motif_name: current.motif_name,
