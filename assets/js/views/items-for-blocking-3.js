(function (global, factory) {
  ...
  function openAvailableItemsWindow(windows, subplant, parentWin = null) {
    ...
    return new Promise((resolve, reject) => {
      ...
      grid.setHeader('&nbsp;,AREA,BARIS,NO. PLT.,MOTIF NAME,TGL PRODUKSI,PLT. AGE,QUALITY,SIZE,SHADE,QTY',null,
        ['', '', '', '', '', '', '', '', '', '', TEXT_RIGHT_ALIGN]);
      grid.setColumnIds('is_checked,area,baris,pallet_no,motif_name,tanggal,aging,quality,size,shading,qty');
      grid.setColTypes('ch,rotxt,ron,rotxt,rotxt,rotxt,ron,rotxt,rotxt,ron,ron');
      grid.setInitWidths('40,200,50,140,*,100,70,80,50,60,120');
      grid.setColAlign('center,left,right,left,left,center,right,center,left,left,right');
      grid.setNumberFormat('0,000', grid.getColIndexById('qty'), ".", ",");
      grid.attachHeader(['&nbsp;', FILTERS.SELECT, FILTERS.SELECT, FILTERS.TEXT, FILTERS.TEXT, FILTERS.SELECT, FILTERS.TEXT, FILTERS.SELECT, FILTERS.SELECT, FILTERS.TEXT, FILTERS.TEXT]);
