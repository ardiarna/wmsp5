...
<head>
  ...
  <title>Grafik Barang Pecah</title>
...
<body>
  ...
  <script type="text/javascript">
    ...
    function loadChart() {
      $.ajax({
        url: FRM+ "?mode=barangpecah&jns="+vJns+"&bln="+vBln+"&thn="+vThn+"&sub="+vSub, 
        success: function(result){
          var o = JSON.parse(result);
          tampilChart('kontener1', 'column', 'Barang Pecah', {type: 'category',categories:o.kategori}, true, o.data_a);
